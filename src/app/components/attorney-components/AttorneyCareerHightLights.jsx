    ...
    <div className='bg-[#EEEEEE]'>
        <div className='max-w-[75rem] max-lg:px-10 max-lg:flex-col m-auto flex flex-col gap-5  px-14 py-20 '>
            ...
            <div className='flex max-md:flex-col gap-5 justify-between'>
                <div className='flex flex-wrap w-1/2 max-md:w-full gap-5 justify-between'>
                    {careerHighlights1.map((career, index) => (
                        <div className='w-full max-md:w-full flex flex-col rounded-lg bg-white p-5 gap-3 shadowCareerhightlightscard flex-grow flex-shrink' key={index} >
                ...
                <div className='flex flex-wrap w-1/2 max-md:w-full gap-5 justify-between'>
                    {careerHighlights2.map((career, index) => (
                        <div className='w-full max-md:w-full flex flex-col rounded-lg bg-white p-5 gap-3 shadowCareerhightlightscard flex-grow flex-shrink' key={index} >
                            <h1 className='font-bold text-gray-800 hightlightText'>{career.title}</h1>
                            <h2 className='font-semibold text-sm text-gray-600'>{career.semiTitle}</h2>
                            <p className='text-sm text-gray-500'>{career.description}</p>
